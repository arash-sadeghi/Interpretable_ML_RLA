...
class SUPERVISOR:
    def __init__(self,ROBN,codeBeginTime,showFrames,globalQ,record,Lx,Ly,cueRadius,visibleRaduis,\
        ...
        self.QRloc={'QR1':(self.Lx,self.Ly//4),'QR2':(self.Lx,self.Ly//4*2),'QR3':(self.Lx,self.Ly//4*3),\
            'QR4':(0,3*self.Ly//4),'QR5':(0,2*self.Ly//4),'QR6':(0,self.Ly//4)}
...
# generateRobots ...............................................................................................................
    def generateRobots(self):
        ...
        '''immutable pointer stuff position and rotation of all robots'''
        self.swarmPosList=[]
        for i in range(self.ROBN):
        ...
        for i in range(self.ROBN):
            self.NASfunction.append(self.swarm[i].groundSensorValue)
# visualize ....................................................................................................................
    def visualize(self):
        if self.record or self.showFrames:
            ...
            for i in range(self.ROBN):
                ...
                if self.method=="RL" or self.method=="DDPG":
    ...
    def avoid(self,cols,specific=False):
        if specific==False:
            ...
            for pairs in c:
                ...
                elif self.method=="RL" or self.method=="DDPG":
...
# checkCollision ...............................................................................................................
    def checkCollision(self,specific=False,robotNum=None):
        ...
        if specific==False:
            ...
            ''' before using this function rotations must be made sure to be standard'''
            all_rots[all_rots<0]+=360 
            all_rots[all_rots>360]-=360 
                            ...
                            if j in rot_conds[i]:
                                ...
                                if self.method=='RL' or self.method=='DDPG':
                                    if self.swarm[j].inAction==True:
                                        #* self.swarm[j].inAction=False #! fundemetal change
...
class ROBOT(SUPERVISOR):
    def __init__(self,SUPERVISOR,name):
        ...
        if self.SUPERVISOR.method=="LBA" or self.SUPERVISOR.method=="RL" or self.SUPERVISOR.method=="DDPG":
...
# move .........................................................................................................................
    def move(self):
            ''' making sure that angle is between 0 and 360 always. its a double check same is written in checkCol fn '''
            self.rotation2B[0]=RotStandard(self.rotation2B[0])
            self.rotation[0]=np.copy(self.rotation2B)[0]
...
# groundSense ..................................................................................................................
    def groundSense(self):
        ...
        if self.position[0]<= self.Ylen-(self.SUPERVISOR.visibleRaduis+2) and \
            self.position[0]>= (self.SUPERVISOR.visibleRaduis+2) and \
            self.position[1]>=(self.SUPERVISOR.visibleRaduis+2) and \
            self.position[1]<=self.Xlen-(self.SUPERVISOR.visibleRaduis+2):

            self.groundSensorValue=255-temp[0]
        else:
            self.groundSensorValue=0

        """ in order to keep track of ground sensor values without function"""
        self.SUPERVISOR.NASfunction[int(self.robotName)]=self.groundSensorValue 
...
# actAndReward .................................................................................................................
    def actAndReward(self,rewardInp=None):
        if self.inAction==False:
            ...
            if self.SUPERVISOR.method=='DDPG' : # continues env:
                ''' DDPG '''
                
                state_norm=self.state/len(self.SUPERVISOR.QRloc)
                action_norm=[0,0]
                action_norm[0]=self.action[0]/self.maxlen
                action_norm[1]=(self.action[1]-90)/180 #! to make angle compatible with orientation of aruco in one robot test exp
            ...
            if self.robotName=='0':
                self.SAR.append(np.array([self.SUPERVISOR.getTime(),self.state,self.actionIndx,self.reward]))
